...
SELECT 
    ...
    D.ROUTE_SHORT_NAME, 
    IFF(
         SPLIT_PART(A.ARRIVAL_TIME, ':', '1') > 23, -- Poprawiłem na 1, jeśli SPLIT_PART liczy od 1 w Snowflake
         CONCAT(TRUNCATE(SPLIT_PART(A.ARRIVAL_TIME, ':', '1') - 24, 0), RIGHT(A.ARRIVAL_TIME, 6)),
         A.ARRIVAL_TIME
    ) AS ARRIVAL_TIME,
    A.STOP_SEQUENCE, 
    ...
    C.STOP_LON,
    IFF(
         SPLIT_PART(A.ARRIVAL_TIME, ':', '1') > 23,
